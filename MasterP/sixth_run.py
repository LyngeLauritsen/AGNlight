...
for i_run in range(runs):
    ...
    np.savetxt('long_run/NGC3783/thermal_list_6',np.array(thermal_list))
    np.savetxt('long_run/NGC3783/K_list_6',K_list)
    np.savetxt('long_run/NGC3783/H_list_6',H_list)
    np.savetxt('long_run/NGC3783/J_list_6',J_list)
    np.savetxt('long_run/NGC3783/g_list_6',g_list)
    np.savetxt('long_run/NGC3783/r_list_6',r_list)
    np.savetxt('long_run/NGC3783/i_list_6',i_list)
    np.savetxt('long_run/NGC3783/transfer_list_6',np.array(transfer_list))
    np.savetxt('long_run/NGC3783/cont_list_6',continuous_list)
