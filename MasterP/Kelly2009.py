...
This is a piece of code to recreate the Kelly et al. 2009 paper.
"""
...
global_variable_share = np.loadtxt('timefluxsigma.txt')
global_variable_share_2 = np.loadtxt('time1flux1sigma1.txt')

time = global_variable_share[0]
flux = global_variable_share[1]
sigma = global_variable_share[2]

time1 = global_variable_share_2[0]
flux1 = global_variable_share_2[1]
sigma1 = global_variable_share_2[2]
