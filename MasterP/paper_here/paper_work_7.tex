...
\section[AGN and Cosmology]{AGN and Cosmology\footnote{Apart from the, when relevant, specified papers this section relies heavily on Mo, Bosch and White 2010, Carroll and Ostlie 2014 and Neal Jackson \emph{The Hubble Constant} 2015}}
...
\subsection[Original Data Material and Kelly manipulations]{Original Data Material and Kelly manipulations\footnote{This section relies upon the paper Kelly et al. 2009\cite{Kelly2009}}} \label{Kelly}
...
\begin{equation}
f(x) = A_{T}\frac{1}{x\sigma_{Dust}\sqrt{2\pi}}e^{-\frac{(ln(x)-\mu_{Dust})^2}{2\sigma_{Dust}^2}} - (1 - A_{T})N_{AD}\frac{1}{x\sigma_{AD}\sqrt{2\pi}}e^{-\frac{(ln(x)-\mu_{AD})^2}{2\sigma_{AD}^2}},
\label{eq:TF_full}
\end{equation}
with $A_{T}$ being the fraction of the complete transfer function contribution originating from the dust torus and $N_{AD}$ being the normalisation of the accretion disk flux transfer function. 

\subsubsection[Accretion Disk Transfer Function contribution]{Accretion Disk Transfer Function contribution\footnote{Nuñez, Chelouche \& Kaspi 2018\cite{Nunez2018}}}
