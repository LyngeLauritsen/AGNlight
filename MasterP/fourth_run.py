...
for i_run in range(runs):
    ...
    np.savetxt('long_run/NGC3783/thermal_list_8',np.array(thermal_list))
    np.savetxt('long_run/NGC3783/K_list_8',K_list)
    np.savetxt('long_run/NGC3783/H_list_8',H_list)
    np.savetxt('long_run/NGC3783/J_list_8',J_list)
    np.savetxt('long_run/NGC3783/g_list_8',g_list)
    np.savetxt('long_run/NGC3783/r_list_8',r_list)
    np.savetxt('long_run/NGC3783/i_list_8',i_list)
    np.savetxt('long_run/NGC3783/transfer_list_8',np.array(transfer_list))
    np.savetxt('long_run/NGC3783/cont_list_8',continuous_list)
