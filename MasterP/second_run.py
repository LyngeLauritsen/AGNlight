...
for i_run in range(runs):
    ...
    np.savetxt('long_run/NGC3783/thermal_list_2',np.array(thermal_list))
    np.savetxt('long_run/NGC3783/K_list_2',K_list)
    np.savetxt('long_run/NGC3783/H_list_2',H_list)
    np.savetxt('long_run/NGC3783/J_list_2',J_list)
    np.savetxt('long_run/NGC3783/g_list_2',g_list)
    np.savetxt('long_run/NGC3783/r_list_2',r_list)
    np.savetxt('long_run/NGC3783/i_list_2',i_list)
    np.savetxt('long_run/NGC3783/transfer_list_2',np.array(transfer_list))
    np.savetxt('long_run/NGC3783/cont_list_2',continuous_list)
