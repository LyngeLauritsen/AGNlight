...
for i_run in range(runs):
    ...
    np.savetxt('long_run/NGC3783/thermal_list_1',np.array(thermal_list))
    np.savetxt('long_run/NGC3783/K_list_1',K_list)
    np.savetxt('long_run/NGC3783/H_list_1',H_list)
    np.savetxt('long_run/NGC3783/J_list_1',J_list)
    np.savetxt('long_run/NGC3783/g_list_1',g_list)
    np.savetxt('long_run/NGC3783/r_list_1',r_list)
    np.savetxt('long_run/NGC3783/i_list_1',i_list)
    np.savetxt('long_run/NGC3783/transfer_list_1',np.array(transfer_list))
    np.savetxt('long_run/NGC3783/cont_list_1',continuous_list)
