...
for i in range(runs):
    ...
    for i1 in range(runs1):
        ...
        if chi2 < chi1 \
           ...
           and (data_comp_z[:,2] >= 0.).all() == True: # \
            ...
            if try1 == 3 and i1 > 1:
                try1 = 0
            elif try1 == 0 and random.random() < 0.01:
                try1 = 1.1
    ...
    plt.plot(x_list,transfer_power_K,color='g')
    plt.plot(x_list,transfer_power_H,color='r')
    plt.plot(x_list,transfer_power_J,color='b')
    plt.plot(x_list,transfer_thermal,color='orange')
