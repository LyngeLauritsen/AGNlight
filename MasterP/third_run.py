...
for i_run in range(runs):
    ...
    np.savetxt('long_run/NGC3783/thermal_list_3',np.array(thermal_list))
    np.savetxt('long_run/NGC3783/K_list_3',K_list)
    np.savetxt('long_run/NGC3783/H_list_3',H_list)
    np.savetxt('long_run/NGC3783/J_list_3',J_list)
    np.savetxt('long_run/NGC3783/g_list_3',g_list)
    np.savetxt('long_run/NGC3783/r_list_3',r_list)
    np.savetxt('long_run/NGC3783/i_list_3',i_list)
    np.savetxt('long_run/NGC3783/transfer_list_3',np.array(transfer_list))
    np.savetxt('long_run/NGC3783/cont_list_3',continuous_list)
